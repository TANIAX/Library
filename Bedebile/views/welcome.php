		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="https://www.bede.fr/media/librairies/x207.jpg.pagespeed.ic.kJ2fCMikf4.jpg" alt="First slide">
					<!-- Static Header -->
				...
				<div class="item">
					<img src="https://mtaregion.com/wp-content/uploads/background_librairie-poirier.jpg" alt="Second slide">
					<!-- Static Header -->
					<div class="header-text hidden-xs">
						<div class="col-md-12 text-center">
							<h2>
