		...
		<tbody>
			<?php foreach($article as $article):?>
				<tr>
					...
					<td><a href="panier?del=<?=$article->article_id?>"><span class="glyphicon glyphicon-trash"></span></a></td>
				</tr>
			<?php endforeach; ?>
			<td></td>
			<td></td>
			...
			<td><button type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-ok"></span> Ok </button></td>
		</tbody>
	</table>
</div>
<?php
