						...
						<?php if (isset($_SESSION['role'])==1){ ?>
							<p class="editer">
								<form class="test" action="edit_article" method="post">
									<button type="submit" type="submit" name="update_article" class="btn btn-primary" value="<?=$article->article_id ?>">Editer</button>
									<button type="submit" type="submit" name="delete_article" class="btn btn-danger" value="<?=$article->article_id ?>">Supprimer</button>
								</form>
							</p>
						<?php }?>
					</li>
