...
<fieldset>
    ...
    <form class="form-horizontal" action="edit_article" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="article_nom" name="article_nom" type="text" placeholder="Nom de l'article"
                       value="<?= $article->article_nom ?>" class="form-control input-md">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="article_prix" name="article_prix" type="text" placeholder="Prix de l'article"
                       value="<?= $article->article_prix ?>" class="form-control input-md">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="article_date" name="article_date" type="date" value="<?= $article->article_date ?>"
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="article_author" name="article_author" type="text" placeholder="Auteur de l'article"
                       value="<?= $article->article_auteur ?>" class="form-control input-md">
            </div>
        </div>
        <!-- Text input-->
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="article_editor" name="article_editor" type="text" placeholder="Éditeur de l'article"
                       value="<?= $article->article_editeur ?>" class="form-control input-md">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="article_isbn" name="article_isbn" type="text" placeholder="ISBN de l'article"
                       value="<?= $article->article_isbn ?>" class="form-control input-md">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="article_image" name="article_image" type="text"
                       placeholder="Lien de l'image | ex :http://res.cloudinary.com/dfencxbqa/image/upload/v..."
                       value="<?= $article->article_image ?>" class="form-control input-md">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <button class="btn btn-success" type="submit" name="update" value="<?= $article->article_id ?>"><span
                            class="glyphicon glyphicon-thumbs-up"></span>Editer
                </button>
            </div>
        </div>
