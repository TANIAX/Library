  ...
  <div class="container">
    <div class="row row1">
      <ul class="largenav pull-right">
        ...
        <li class="upper-links dropdown"><a class="links" href="">Mon compte</a>
          <ul class="dropdown-menu">
            <?php if(empty($_SESSION['login']))
            {
              echo "<li class=\"profile-li\"><a class=\"profile-links\" href=\" "?><?=URL . "login_register\">Login</a></li>";
            }
            else {
              if ($_SESSION['role'] == 1) {
...
<div id="mySidenav" class="sidenav">
  <div class="container" style="background-color: #2222; padding-top: 10px;">
